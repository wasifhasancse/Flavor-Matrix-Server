    ...
    static async handleWebhook(rawBody, signature) {
        ...
        if (event.type === "checkout.session.completed") {
            ...
            if (type === "membership_upgrade" && userId) {
                ...
                await db_1.collections.users.updateOne({ _id: new mongodb_1.ObjectId(userId) }, { $set: { isPremium: true, updatedAt: new Date() } });
            }
                ...
                await db_1.collections.payments.insertOne({
                    userId,
                    recipeId,
